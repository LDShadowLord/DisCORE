...
class Notify:
    ...
    def embed(self, description, title, url=None, color=0x7289da, thumbnail=None, image=None, author=None, removeFooter=False):
        ...
        if removeFooter != True:
            exportEmbed.set_footer("Generated by DisCORE "+discore_version, "https://raw.githubusercontent.com/LDShadowLord/DisCORE/master/DisCORE/assets/logo.png")
    ...
    def notify(self, embed, catch=False):
        ...
        The 'embed' attribute is an embed object
        The 'catch' attribute catches any errors when notifying without crashing the script
        """
        if catch != True:
